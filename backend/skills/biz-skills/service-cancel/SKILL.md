...
stateDiagram-v2
    ...
    state 未知扣费流程 {
        ...
        定位异常项 --> 判断是否增值业务: 逐项解释费用来源，识别未知扣费
        ...
        反馈扣费结果 --> 反馈扣费完成: 说明退款规则（当月不退，次月不再扣）
    }
    ...
    state 误订退款流程 {
        ...
        是否24小时内 --> 全额退款处理: 订购24小时内 %% ref:cancellation-policy.md#误订退款指引
        是否24小时内 --> 次月生效处理: 订购超过24小时
        全额退款处理 --> 执行退订_误订: cancel_service(phone, service_id) 全额退款 %% tool:cancel_service
