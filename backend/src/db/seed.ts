...
async function seed() {
  ...
  const toolResourceDefs: Array<{
    ...
    { res_id: 'res-query-subscriber', res_name: 'subscriber_query', server_id: 'mcp-user-info', mcp_url: 'http://127.0.0.1:18003/mcp', mcp_tool_name: 'query_subscriber', tool_name: 'query_subscriber', tool_desc: '根据手机号查询电信用户信息（套餐、状态、余额、用量分析、增值业务详情、欠费分层）', input_schema: { type: 'object', properties: { phone: { type: 'string', description: '用户手机号' } }, required: ['phone'] }, mock_source: 'mcp-user-info' },
