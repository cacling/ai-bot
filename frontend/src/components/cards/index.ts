...
registerCard({
  ...
  Icon: PhoneCall,
  headerClass: 'bg-gradient-to-r from-violet-600 to-violet-500',
  colSpan: 1,
  defaultOpen: true,
  defaultCollapsed: false,
...
registerCard({
  ...
  Icon: Smile,
  headerClass: 'bg-gradient-to-r from-rose-500 to-pink-400',
  colSpan: 1,
  defaultOpen: true,
  defaultCollapsed: false,
...
registerCard({
  ...
  Icon: PhoneForwarded,
  headerClass: 'bg-gradient-to-r from-amber-500 to-orange-400',
  colSpan: 1,
  defaultOpen: true,
  defaultCollapsed: false,
